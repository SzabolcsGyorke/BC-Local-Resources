codeunit 90101 "BC LRS Print Event Subscriber"
{
    ...
    begin
        ...
        BCLRSEntry.Init();
        BCLRSEntry."Company Name" := CopyStr(CompanyName(), 1, MaxStrLen(BCLRSEntry."Company Name"));
        ...
        BCLRSEntry."Document Name" := CopyStr(FileName, 1, MaxStrLen(BCLRSEntry."Document Name"));
